...
describe AnnotateModels::SchemaInfo do # rubocop:disable Metrics/BlockLength
  describe '.generate' do # rubocop:disable Metrics/BlockLength
    ...
    context 'when option is not present' do # rubocop:disable Metrics/BlockLength
      subject do
        AnnotateModels::SchemaInfo.generate(klass, header)
      end
          ...
          context 'when the primary_key is :id' do # rubocop:disable Metrics/BlockLength
            ...
            context 'when indexes exist' do
              context 'when option "show_indexes" is true' do
                subject do
                  AnnotateModels::SchemaInfo.generate(klass, header, show_indexes: true)
                end
              ...
              context 'when option "simple_indexes" is true' do
                subject do
                  AnnotateModels::SchemaInfo.generate(klass, header, simple_indexes: true)
                end
            ...
            context 'when foreign keys exist' do
              ...
              context 'when option "show_foreign_keys" is specified' do
                subject do
                  AnnotateModels::SchemaInfo.generate(klass, header, show_foreign_keys: true)
                end
              ...
              context 'when option "show_foreign_keys" and "show_complete_foreign_keys" are specified' do
                subject do
                  AnnotateModels::SchemaInfo.generate(klass, 'Schema Info', show_foreign_keys: true, show_complete_foreign_keys: true)
                end
        ...
        context 'when the primary key is specified' do
          context 'when the primary_key is :id' do
            ...
            context 'when option "format_rdoc" is true' do
              subject do
                AnnotateModels::SchemaInfo.generate(klass, AnnotateModels::PREFIX, format_rdoc: true)
              end
            ...
            context 'when option "format_markdown" is true' do
              context 'when other option is not specified' do
                subject do
                  AnnotateModels::SchemaInfo.generate(klass, header, format_markdown: true)
                end
              ...
              context 'when option "show_indexes" is true' do
                subject do
                  AnnotateModels::SchemaInfo.generate(klass, header, format_markdown: true, show_indexes: true)
                end
              ...
              context 'when option "show_foreign_keys" is true' do
                subject do
                  AnnotateModels::SchemaInfo.generate(klass, header, format_markdown: true, show_foreign_keys: true)
                end
    ...
    describe 'when option is present' do
      ...
      context 'when header is "== Schema Information"' do
        ...
        context 'when "format_doc" and "with_comment" are specified in options' do
          subject do
            AnnotateModels::SchemaInfo.generate(klass, AnnotateModels::PREFIX, format_rdoc: true, with_comment: true)
          end
        ...
        context 'when "format_markdown" and "with_comment" are specified in options' do
          subject do
            AnnotateModels::SchemaInfo.generate(klass, AnnotateModels::PREFIX, format_markdown: true, with_comment: true)
          end
